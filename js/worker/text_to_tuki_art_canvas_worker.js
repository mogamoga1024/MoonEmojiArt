...
onmessage = async evnt => {
    ...
    try {
        ...
        tukiArt = TukiArtGenerator.createTukiArt(monoCanvas.pixels, prm.isTextColorReverse, prm.isTextTateLinePowerUp, prm.isTextYokoTopLinePowerUp, prm.isTextYokoBottomLinePowerUp, 2);
