...
onmessage = async evnt => {
    ...
    try {
        ...
        tukiArt = TukiArtGenerator.createTukiArt(monoCanvas.pixels, prm.isImageColorReverse, prm.isImageYokoLinePowerUp, prm.isImageTateLinePowerUp, prm.isImageYokoTopLinePowerUp, prm.isImageYokoBottomLinePowerUp, prm.imageColorCount, prm.useImageNanameMikaduki);
